...
function onConnect() {
    ...
    client.subscribe("module_11/temp");
    client.subscribe("module_11/hum");
...
function onMessageArrived(message) {
  ...
  if(message.destinationName == "module_11/temp"){
    let tempValue = document.getElementById("tempValue");
    tempValue.innerHTML = message.payloadString;
  }

  if(message.destinationName == "module_11/hum"){
    let humValue = document.getElementById("humValue");
    humValue.innerHTML = message.payloadString;
  }
}